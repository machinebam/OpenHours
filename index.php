...
$theday = date("l");
//School Holidays
$s_date = strtotime("25 December 2014");
$e_date = strtotime("27 December 2014");
...
$xmas = strtotime("25 December 2014");
$boxing = strtotime("26 December 2014");
...
<?php echo $theday . "<br />";
if (date(strtotime("+0 Days")) > $s_date && date(strtotime("+0 Days")) < $e_date) 
{ if ($plus0 == "Sat") {echo "10.00am - 5.00pm";} elseif ($plus0== "Sun") {echo "10.00am - 5.00pm";}else {echo "Closed";}}
else 
...
{ if ($plus1 == "Sat") {echo "10.00am - 5.00pm";} elseif ($plus1== "Sun") {echo "10.00am - 5.00pm";}else {echo "Closed";}}
else 
...
{ if ($plus2 == "Sat") {echo "10.00am - 5.00pm";} elseif ($plus2== "Sat") {echo "10.00am - 5.00pm";}else {echo "Closed";}
}
else 
...
{ if ($plus3 == "Sat") {echo "10.00am - 5.00pm";} elseif ($plus3== "Sun") {echo "10.00am - 5.00pm";}else {echo "Closed";}}
else 
...
{ if ($plus4 == "Sat") {echo "10.00am - 5.00pm";} elseif ($plus4== "Sun") {echo "10.00am - 5.00pm";}else {echo "Closed";}}
else 
...
{ if ($plus5 == "Sat") {echo "10.00am - 5.00pm";} elseif ($plus5== "Sun") {echo "10.00am - 5.00pm";}else {echo "Closed";}}
else 
...
{ if ($plus6 == "Sat") {echo "10.00am - 5.00pm";} elseif ($plus6== "Sun") {echo "10.00am - 5.00pm";}else {echo "Closed";}}
else 
